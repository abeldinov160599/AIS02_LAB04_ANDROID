...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            idTopic = savedInstanceState.getInt(ID_TOPIC, R.id.WhatIsCurrency);
        } else {
            ...
            idTopic = sPref.getInt(ID_TOPIC, R.id.WhatIsCurrency);
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        // Блок выбора тем
        if (id == R.id.WhatIsCurrency) {
            webView.loadUrl(resourceDir + "PAGE01/WhatIsCurrency.htm");
        } else if (id == R.id.HistoryOfCurrency) {
            webView.loadUrl(resourceDir + "PAGE02/HistoryOfCurrency.htm");
        } else if (id == R.id.KZCurrency) {
            webView.loadUrl(resourceDir + "PAGE03/KZCurrency.htm");
